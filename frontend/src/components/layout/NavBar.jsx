            ...
            <ul className="flex flex-wrap justify-end">
                <li className='hover:brightness-75 h-full m-2 mr-auto'>
                    <Link to="/">
                        <svg
                            ...
                            aria-hidden="true"
                            className="iconify iconify--logos h-full w-12"
                            viewBox="0 0 256 228"
                        >
                            <path
                                fill="#00D8FF"
                ...
                <li className='flex md:hidden mr-5'>
                    <button className="md:hidden" onClick={toggleMenu}>
                        {showMenu ? <AiOutlineClose className={estiloBotonHamburguesa}/> : <AiOutlineMenu className={estiloBotonHamburguesa}/>}
                    </button>
                </li>

            </ul>
            {showMenu && (<ul className="md:hidden absolute w-full h-full bg-blue-800">
                {navItems.map((item) => (
                    <li key={item.id}><Link to={item.url} className="block p-2 hover:bg-blue-950">{item.content}</Link>
                    </li>))}
            </ul>)}
        </nav>
