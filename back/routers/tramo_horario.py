...
@router.get("/{id}", response_model=TramoHorarioDTO, status_code=status.HTTP_200_OK)
...
@router.get("/nombre/{nombre}", response_model=TramoHorarioDTO, status_code=status.HTTP_200_OK)
...
@router.get("/", response_model=List[TramoHorarioDTO], status_code=status.HTTP_200_OK)
...
@router.post("/", response_model=TramoHorarioDTO, status_code=HTTP_201_CREATED)
...
@router.put("/{id}", response_model=TramoHorarioDTO, status_code=status.HTTP_200_OK)
